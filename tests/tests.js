...
describe('Mi9 Coding Challenge Tests', function() {
  ...
  it('should call express with no payload and get a 400 back', function(done) {
    request(app)
      .post('/')
  ...
  it('should call express with a payload and get a 200 back', function(done) {
    request(app)
      .post('/').send(payload)
      .expect('Content-Type', /json/)
      .expect(200, done);
  ...
  it('should call the API with a valid payload and get back a valid response payload', function(done) {
    request(app)
      .post('/').send(payload)
      .expect('Content-Type', /json/)
